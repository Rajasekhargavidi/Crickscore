      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-12">
            <h1 className="header text-danger">Crikscore</h1>
            <div className="w-100 ">
              <h5 className="header">
        ...
        <div className="row">
          <div className="col-sm-12">
            <div className="icon-block">
              <h5 className="">Speeds up development</h5>
          ...
          <div className=" col-sm-12">
            <div className="icon-block">
              <h5 className="">User Experience Focused</h5>
              <p className="light">
          ...
          <div className=" col-sm-12">
            <div className="icon-block">
              <h5 className="">Easy to work with</h5>
              <p className="light">
